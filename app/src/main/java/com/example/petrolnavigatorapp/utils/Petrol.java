...
/**
 * Class that represents particular petrol station.
 * It contains data about its name, address, localization, available fuel types and fuels.
 */
public class Petrol implements Serializable {
    ...
    public Petrol(String name, double lat, double lon, String address) {
        ...
        String[] names = {"Pb98", "Pb95", "ON", "ON_Ultimate", "LPG", "CNG", "Elektryczny", "E85"};
